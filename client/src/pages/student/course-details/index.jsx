...
{   const { studentViewCourseDetails,setStudentViewCourseDetails,
    currentCourseDetailsId,setCurrentCourseDetailsId, loadingState,setLoadingState,} = useContext(StudentContext);
  ...
  async function handleCreatePayment() {
    ...
    // console.log(getIndexOfFreePreviewUrl,studentViewCourseDetails?.curriculum[getIndexOfFreePreviewUrl],"Rupali")

    return (
        <div className=" mx-auto p-4">
      <div className="bg-pink-400 text-white p-8 rounded-t-lg">
        ...
        <aside className="w-full md:w-[500px]">
          <Card className="sticky top-4">
            <CardContent className="p-6">
              ...
              <Button onClick={handleCreatePayment} className="w-full bg-pink-400">
                Buy Now
              </Button>
            </CardContent>
          </Card>
